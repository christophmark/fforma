...
class LightGBM:
    ...
    def _train_lightgbm(self, params):
        ...
        if self.use_cv:
            ...
            num_round, _ = self._train_lightgbm_cv(params)
        ...
        if self.objective in self.dict_obj.keys():
            gbm_model = lgb.train(
                ...
                feval=lambda preds, train_data: [self.feval(preds, train_data),
                                                 self.fforma_loss(preds, train_data)],
    ...
    # Functions for training lightgbm
    def _train_lightgbm_cv(self, params):
    ...
    def _search_optimal_params_lightgbm(self, param_grid):
